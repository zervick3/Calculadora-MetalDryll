...
import TablaResultadoFibro from "../Fibrecemento/TablaResultadoFibro";

function InputFormFibrocemento() {
  ...
  const Plancharh = (parseFloat(form.area) * 0.74) / 2;
  ...
  const sika = parseFloat(form.area) * 0.31;
...
export default InputFormFibrocemento;
